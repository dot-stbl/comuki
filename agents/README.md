...
- `.agents/docs/comuki-project-structure.md` § 3
- `.agents/docs/comuki-decisions.md` § "Два агента под две ситуации, три пакета"
- `.agents/docs/comuki-architecture.md` § 05 (знания и правила), § 06 (workflow)

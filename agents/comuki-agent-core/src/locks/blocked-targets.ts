...
export const BLOCKED_TOOL_TARGETS: readonly LockRule[] = [
  {
    ...
    kind: "edit-path",
    pattern: "**/*.test.*",
    reason: TESTS_OWNED_BY_PLATFORM,
  },
  {
    id: "no-edit-spec",
    kind: "edit-path",
  ...
  {
    id: "no-edit-tests-dir",
    kind: "edit-path",
    pattern: "**/tests/**",
    reason: TESTS_OWNED_BY_PLATFORM,
  },
  {
    id: "no-edit-underscore-tests-dir",
    kind: "edit-path",
    pattern: "**/__tests__/**",
    reason: TESTS_OWNED_BY_PLATFORM,
  },
  {
    ...
    reason: NO_SIDE_INSTALLS,
  },
  {
    id: "no-npm-add",
    kind: "tool-name",
    pattern: "Bash(npm add*",
    reason: NO_SIDE_INSTALLS,
  },
  {
    id: "no-bun-add",
  ...
  {
    id: "no-dotnet-add-package",
    kind: "tool-name",
    pattern: "Bash(dotnet add package*",
    reason: NO_SIDE_INSTALLS,
  },
  {
    id: "no-push-main",

...
export function AppShellSidebar({ items }: AppShellSidebarProps) {
  return (
    <aside className="flex w-44 shrink-0 flex-col gap-1 overflow-y-auto border-r border-border bg-sidebar p-3">
      ...
      {items.map((item) => (
        <Link
          ...
          activeProps={{ className: "bg-sidebar-accent font-medium text-sidebar-accent-foreground border-l-primary" }}
        >

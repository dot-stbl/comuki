 ...
 */
export const postApiV1ChatSessionsSessionidMessages400Schema = z.lazy(
 ...
 */
export const postApiV1ChatSessionsSessionidMessages404Schema = z.lazy(
  () => problemDetailsSchema
)
 ...
 */
export const postApiV1ChatSessionsSessionidMessages409Schema = z.lazy(
  () => problemDetailsSchema
)
 ...
 */
export const postApiV1ChatSessionsSessionidMessages503Schema = z.lazy(
  () => problemDetailsSchema
)

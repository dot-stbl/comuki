...
"idleTtlSeconds": z.nullable(z.union([z.int(), z.string().regex(/^-?(?:0|[1-9]\d*)$/)])),
"approveRequired": z.boolean(),
"knowledgeEnabled": z.boolean(),
"verifyEnabled": z.boolean(),
"proxyEnabled": z.boolean(),
"softBudgetUsdMicros": z.nullable(z.union([z.int(), z.string().regex(/^-?(?:0|[1-9]\d*)$/)])),
"hardBudgetUsdMicros": z.nullable(z.union([z.int(), z.string().regex(/^-?(?:0|[1-9]\d*)$/)]))
    })
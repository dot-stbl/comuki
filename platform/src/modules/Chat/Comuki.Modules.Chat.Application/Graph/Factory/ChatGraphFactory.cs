...
public static class ChatGraphFactory
{
    ...
    public static CompiledGraph Compile(IServiceProvider services, ICheckpointer checkpointer)
    {
        return new StateGraph()
            ...
            .AddChannel(ChatChannels.ToolInput, ChannelKind.LastValue)
            .AddChannel(ChatChannels.ToolResult, ChannelKind.LastValue)
            .AddChannel(ChatChannels.ToolStatus, ChannelKind.LastValue)
            .AddChannel(ChatChannels.ToolDurationMs, ChannelKind.LastValue)
            .AddChannel(ChatChannels.Thinking, ChannelKind.LastValue)

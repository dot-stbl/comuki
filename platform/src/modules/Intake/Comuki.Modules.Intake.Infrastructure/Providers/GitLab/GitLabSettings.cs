...
/// "apiTokenEnv": "COMUKI_GL_TOKEN"}</c>. The numeric project id is the
/// stable API handle; the base URL is overridable for self-hosted.
/// </summary>
...
public sealed record GitLabSettings(
    ...
    string? ApiTokenEnv)
{
    /// <summary>Default GitLab API base (overridable for self-hosted).</summary>

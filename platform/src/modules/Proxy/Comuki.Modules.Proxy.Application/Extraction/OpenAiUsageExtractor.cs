...
/// <summary>
/// Parses the OpenAI <c>/v1/chat/completions</c> response shape:
/// <c>model</c> at the root, <c>usage.prompt_tokens</c> +
/// <c>usage.completion_tokens</c> underneath. Streaming responses arrive
/// as SSE; the transformer that captures the response body for metering
/// concatenates the data lines before calling here.
/// </summary>
public sealed class OpenAiUsageExtractor : IProxyUsageExtractor
{
        ...
        CancellationToken cancellationToken = default)
    {
        ...
        try
        {
            ...
            var inputTokens = ReadInt(usageElement, "prompt_tokens");
            var outputTokens = ReadInt(usageElement, "completion_tokens");

...
/// structured state fields (stringified), and <c>exception</c> when
...
/// </summary>
public sealed class ComukiJsonConsoleFormatter(TimeProvider? clock = null) : ConsoleFormatter(FormatterName)
{
    ...
    {
        ComukiJsonConsoleWriter.Write(entry, clock.GetUtcNow(), textWriter);
    }
}
...
{
    public static void Write<TState>(in LogEntry<TState> entry, DateTimeOffset timestamp, TextWriter writer)
    {

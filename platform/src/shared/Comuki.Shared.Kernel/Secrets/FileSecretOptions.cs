...
/// when false, <see cref="FileSecretProvider"/> is replaced with
/// <see cref="NullSecretProvider"/> so a <c>file:/...</c> reference
/// surfaces a typed <see cref="SecretRefUnsetException"/> rather than a
/// successful read of an unconfigured path. <see cref="RootPath"/>, when
...
public sealed class FileSecretOptions
{
    ...
    /// <summary>Master switch — when false, <see cref="FileSecretProvider"/> is replaced by <see cref="NullSecretProvider"/>.</summary>

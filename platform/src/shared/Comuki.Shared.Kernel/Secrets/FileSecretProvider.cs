...
/// <see cref="SecretRefUnsetException"/>. Singleton: stateless, I/O
/// happens at call time, not at startup. The
...
public sealed class FileSecretProvider(IOptions<FileSecretOptions> options) : ISecretProvider
{
    ...
    /// <summary>Resolves by reading and trimming the file at <see cref="SecretRef.Path"/>.</summary>
